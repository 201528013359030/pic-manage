...
function send_submit(){
    ...
    $("#announceform-lengthBox").css("display","none");
    ...
    if( $.trim($("#announceform-title").val()).length >100){
         showModal('标题字数超出最大允许值');
		return false;
    }
    if($("#UEContent").css("display") == "block"){
    //    alert(ue.getContentTxt().length);
        if(ue.getContentTxt().length > 1500){
            showModal('正文字数超出最大允许值');
           // $("#announceform-lengthBox").css("display","block");
            return false;
        }
        $("#announceform-content").val(UE.getEditor('editor').getContent());
        $("#announceform-UE").val(1);
    }else if($("#announceform-content").val().length >1500){
        showModal('正文字数超出最大允许值');
        //$("#announceform-lengthBox").css("display","block");
        return false;
    }
...
<div id="wrap" class="wrap">
	...
	<div id="announceform-lengthBox" class="tipBox" style="display:none">		
		<div class="tipInner">
			<i class="ficon ic_wanning"></i>正文字数超出最大允许值
		</div>
	</div>	
...
<div class="modal bs-example-modal-sm check_modal" id="checkModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <p id="checkModal_content" style="text-align: center;"></p>
        </div>
    </div>
</div>
...
function showModal(txt){
    $('#checkModal_content').html(txt);
    $('#checkModal').css('top','40%');
